...
export default function Quiz() {
  ...
  return (
    <div className=" xl:w-[680px] p-12 xl:p-0 max-auto md:w-full md:mx-auto">
      {!quizFinished ? (
        <div className="question-card">
          <h2 className='text-4xl font-bold text-gray-200 mb-12'>{quiz[currentQuestionIndex].question}</h2>
